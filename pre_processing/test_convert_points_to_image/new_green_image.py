...
with open('rgb_2.txt', 'r') as file:
    green_values = [int(line.split()[1]) for line in file]
...
for coord, green in zip(coordinates, green_values):
    x, y = coord
    image[y, x] = [0, green, 0]  # Set red value, and green and blue to 0

# Save the new image
cv2.imwrite('output_green_image.png', image)
