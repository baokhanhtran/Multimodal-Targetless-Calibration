...
with open('rgb_2.txt', 'r') as file:
    blue_values = [int(line.split()[0]) for line in file]
...
for coord, blue in zip(coordinates, blue_values):
    x, y = coord
    image[y, x] = [blue, 0, 0]  # Set red value, and green and blue to 0

# Save the new image
cv2.imwrite('output_blue_image.png', image)
